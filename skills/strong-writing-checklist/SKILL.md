...
1. Show don't tell
  - [ ] **HIGH:** Bruno loved his bone.
    ...
    - Suggest fix: Consider what physical reactions Bruno makes to his bone, does he pounce on it, throw it in the air, carry it around the room in his mouth with his tail wagging?
      - *Example:* Bruno jumped at the kitchen island and pulled his bone from the countertop then paraded it around the room with his tail held high.
  - [ ] **HIGH:** The rain made me sad.
    - Reasoning: Sad is an emotion that can be evoked through body language or subtext.
    - Suggest fix: Prior to this the main character expresses their disappointment that their mother didn't show up to their childhood play and it was raining that day. Lean into this sentiment or use subtext to show how they link this incident to the rain.
      - *Example:* Every time it rains I'm left leaves with a bitter taste in my mouth.
  - [ ] **MEDIUM:** He felt drained when the teacher placed his failing test on his desk.
...
2. Character inconsistencies
  - [ ] **LOW:** John mentions he has an $80,000 truck but he works as a bagger in a grocery store.
      ...
      - Suggest fix: Explain that John is borrowing the truck from a friend, or inherited the truck from his dad, or imply that he is doing underhanded work on the side that would give him a plausible reason for having a truck this expensive. Alternatively, change it to an $8,000 truck that he's still making payments on.
        - *Example:* John's $8,000 truck was his pride and joy even if he was two weeks late making this month's payment.

# Provide a Report From the Evaluation
Provide a comprehensive report on the writing sample evaluated in [book-title]-[date]-evaluation.md file. List the strengths and weaknesses when comparing the writing to the checklist above. Give a rating out of 5 stars with the strength of the writing. Use this format for the report:

# [book-title] Evaluation (April 18, 2026)

## Rating: [number of stars]

[Provide a high level explanation of why you picked this number of stars for the rating.]

## Strengths

[Include a bulleted list of the strengths followed by a high level summary of the strengths of his piece of writing with detailed explanations of why these are strengths. Example format provided below]

* Character voice - this character has a gritty tone that matches the harsh and tramatic life they've lived.
* Worldbuilding - St. Mary's church is a visceral that enhances the immersion into this world

## Weaknesses

[Include a bulleted list of the strengths followed by a high level summary of the strengths of his piece of writing with detailed explanations of why these are strengths. Example format provided below]

* Spelling mistakes - there are 27 misspelled words that break the reader's immersion.
* Character inconsistencies - you have 4 different characters that break from their personality traits or occupation
