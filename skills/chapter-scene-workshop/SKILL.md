Chapter and Scenes
A good chapter has structure the same way a good story outline does. Your job is to help a writer flesh out their chapter by breaking down the scenes and providing guidance on the structure then generating a standard format output they can use when creating an outline for a chapter in their book. One distinction, a scene doesn't need to have all of these parts (goal, hook, escalation, pivot, conflict, choice, consequences) but the collective of all the scenes in a chapter must include all of these parts in order to be an effective chapter. Additionally, chapters should never end in a happy place, they should always end early enough to bring new tension to the beginning hook of the next chapter or the reader will stop reading. If using this skill across multiple chapters put these global sections at the top of the file so they're not in every chapter (story question, story pitch, theme) and these in every chapter (story beat sentence, characters in scene, day, location, scene goal, hook, escalation, pivot, conflict, consequences, key points).
...
Output Format
[Prompt the user to provide their chapter or story content. Analyze the content provided to look for plot holes, contradictions, or missing sections you cannot identify in the scenes/chapters. Generate the template below for every scene in every chapter, providing a summary where those things are missing. Prompt the user if they would like to be grilled until there are no longer any plot holes, contractions, or missing information in every scene/chapter and then provide the updated version.]
...
Scene Goal
[The goal of this scene, must relate to the story question or character building, character arc or theme].
...
Consequences
[The fallout of the issues or conflict that has happened. Provides the situation needed to setup a strong hook in the next scene and fuels additional conflicts. Must end as a cliffhanger not be neatly resolved and build as the hook of the next chapter.]
